...
from .ray_trainer import StreamrlRayTrainer

@hydra.main(config_path="config", config_name="streamrl_ppo_megatron_trainer", version_base=None)
def main(config):
    run_ppo(config)
